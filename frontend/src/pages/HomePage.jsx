        ...
        <div className="role-modal-overlay" onClick={() => setShowRoleModal(false)}>
          <div className="role-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="role-modal-grid">
              ...
              >
                <img src={studentImg} alt="User" className="role-modal-image" />
                <h3 className="role-modal-card-title">User</h3>
        ...
        <div className="role-modal-overlay" onClick={() => setShowSignupForm(false)}>
          <div className="role-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="role-modal-overline">
              {selectedRole === 'USER' ? 'USER' : selectedRole} REGISTRATION
            </p>
            ...
            <form onSubmit={handleSignupSubmit} className="signup-form">
              ...
              <div className="input-group">
                <label htmlFor="username" className="input-label">
                  <img src={nameIcon} alt="Name" style={{ width: '16px', height: '16px' }} />
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div className="input-group">
                <label htmlFor="password" className="input-label">
                  <img src={passwordIcon} alt="Password" style={{ width: '16px', height: '16px' }} />
                  Password
                </label>
                <input
                  type="password"
              ...
              <div className="input-group">
                <label htmlFor="contact" className="input-label">
                  <img src={contactIcon} alt="Contact" style={{ width: '16px', height: '16px' }} />
                  Contact Number
                </label>
                <input
                  type="tel"
